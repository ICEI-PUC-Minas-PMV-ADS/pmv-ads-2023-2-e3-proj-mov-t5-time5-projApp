...
export default class Base {
    ...
    val(d) {
        ...
        const error = (this.validate.errors && this.validate.errors.length)
            ...
            : null;
        throw error
            ? new ValidationError((_a = error.message) !== null && _a !== void 0 ? _a : 'Validation Error', error.keyword === 'required' ? error.params.missingProperty : error.instancePath.substr(1))
